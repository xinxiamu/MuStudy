...
//
//		nashorn.eval(
//				"function reservationRate_credit() { /**/ var rp = reservationRateP; var creditNum = 0; return rp; }",
//				simpleBindings);
...
//		System.out.println("---" + f);
	...
	public static void OctaneBenchmarkNashorn() {
		...
		try {
			CompiledScript scr = nashorn.compile(
					"function reservationRate_credit() { /**/ var rp = reservationRateP; var creditNum = 0; return rp; }");
			scr.eval();
			SimpleBindings simpleBindings = new SimpleBindings();
			simpleBindings.put("reservationRateP", 0.8);
			Double f = (Double) scr.eval(simpleBindings);  
