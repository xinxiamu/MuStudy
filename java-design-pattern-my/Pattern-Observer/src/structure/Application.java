...
import structure.observer.impl.HaiGui;
import structure.observer.impl.UniversityStudent;
import structure.subject.impl.SeekJobCenterSubject;

/**
 * <p>利用观察者模式。</p>
 * <p>演示了一个大学生和一个归国留学者成为求职中心的观察者；</p>
 * <p>当求职中心有新的人才需求信息时，大学生和归国留学者将得到通知</P>
