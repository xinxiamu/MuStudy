...
<link
	href="${basePath}resources/js/lib/ligerUI/skins/Aqua/css/ligerui-all.css"
	rel="stylesheet" type="text/css" />
<link rel="stylesheet" type="text/css" id="mylink" />
<script src="${basePath}resources/js/lib/jquery/jquery-1.3.2.min.js"
	type="text/javascript"></script>
<script src="${basePath}resources/js/lib/ligerUI/js/ligerui.all.js"
	type="text/javascript"></script>
<script src="${basePath}resources/js/lib/ligerUI/js/plugins/ligerTab.js"></script>
<script src="${basePath}resources/js/lib/jquery.cookie.js"></script>
<script src="${basePath}resources/js/lib/json2.js"></script>
<script src="${basePath}resources/js/indexdata.js" type="text/javascript"></script>
<script type="text/javascript">
	...
	var skin_links = {
		"aqua" : "${basePath}resources/js/lib/ligerUI/skins/Aqua/css/ligerui-all.css",
		"gray" : "${basePath}resources/js/lib/ligerUI/skins/Gray/css/all.css",
		"silvery" : "${basePath}resources/js/lib/ligerUI/skins/Silvery/css/style.css",
		"gray2014" : "${basePath}resources/js/lib/ligerUI/skins/gray2014/css/all.css"
	};
	function pages_init() {
	...
	function getLinkPrevHref(iframeId) {
		...
		for (var i = 0; links[i]; i++) {
			...
			if (href && href.toLowerCase().indexOf("ligerui") > 0) {
				return href.substring(0, href.toLowerCase().indexOf("${basePath}resources/js/lib"));
			}
		}
	}
</script>
...
.l-topmenu {
	...
	height: 31px;
	line-height: 31px;
	/* background: url('${basePath}resources/js/lib/images/top.jpg') repeat-x bottom; */
	background:#04620c;
	position: relative;
...
.l-topmenu-logo {
	...
	padding-left: 35px;
	line-height: 26px;
	background: url('${basePath}resources/js/lib/images/topicon.gif') no-repeat 10px 5px;
}
