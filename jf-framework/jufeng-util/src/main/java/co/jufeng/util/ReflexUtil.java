	...
	public static <T> T reflexObject(Map<String, String> data, Object object, Class<T> modelClass) {
		...
		try {
			...
			for (int i = 0; i < name.length; i++) {
				...
				if (data.containsKey(name[i]) && !StringUtil.isEmpty(value)
					...
					if (fields[i].getType() == java.lang.Long.class)
						...
						fields[i].set(object, Integer.parseInt(value));
					else if (fields[i].getType() == java.lang.Float.class)
						fields[i].set(object, Float.parseFloat(value));
					else if (fields[i].getType() == java.lang.Short.class)
						...
						fields[i].set(object, DateUtil.toString(value,
								DateStyle.YYYY_MM_DD_HH_MM_SS.getValue()));
					else if (fields[i].getType() == java.util.Date.class)
						fields[i].set(object, DateUtil.toString(value,
								DateStyle.YYYY_MM_DD_HH_MM_SS.getValue()));
					else if (fields[i].getType() == java.lang.Boolean.class)
