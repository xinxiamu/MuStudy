...
public class StringUtil {
    ...
    public static boolean isEmpty(Object str) {
		if (str == null || str.equals("") || "null".equals(str) || "-1".equals(str + "") || str.toString().length() == 0) {
			return true;
		}
		return false;
	}
	...
	public static String replaceUnderlineAndfirstToUpper(String srcStr, String org, String ob) {
		...
		while (srcStr.indexOf(org) != -1) {
			...
			if (first != srcStr.length()) {
				...
				srcStr = firstCharacterToUpperCase(srcStr);
			}
		}
	...
	public static String propertyToField(String property) {
		return propertyToField(property, "_");
	}

	public static String propertyToField(String property, String append) {
		if (null == property) {
			return "";
		}
		...
		for (char c : chars) {
			if (CharUtils.isAsciiAlphaUpper(c)) {
				sb.append(append + CharUtils.toString(c).toLowerCase());
			} else {
				sb.append(c);
			}
		}
	...
	public static String fieldToProperty(String field) {
		return fieldToProperty(field, '_');
	}

	public static String fieldToProperty(String field, char append) {
		if (null == field) {
			return "";
		}
